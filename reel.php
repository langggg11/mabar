...
?>
    ...
    <script>
        // Load reel products with enhanced search
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (productSearch) {
                productSearch.addEventListener('input', function(e) {
                    ...
                    handleProductSearch(query, 'reel');
                });
            }
            ...
            if (sortSelect) {
                sortSelect.addEventListener('change', function(e) {
                    loadProducts('reel', e.target.value);
                });
            }
        ...
        function createProductCard(product) {
            // Remove target_fish from reel products - only show relevant specs
            const specs = [];
            if (product.gear_ratio) specs.push(`<div class="spec-item"><span class="spec-label">Gear Ratio:</span> <span class="spec-value">${product.gear_ratio}</span></div>`);
            if (product.bearings) specs.push(`<div class="spec-item"><span class="spec-label">Bearings:</span> <span class="spec-value">${product.bearings}</span></div>`);
        ...
        function updateProductCount(count) {
            ...
            if (countElement) {
                countElement.textContent = `Menampilkan ${count} produk reel`;
            }
        }
