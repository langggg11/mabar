...
?>
    ...
    <script>
        // Load umpan products with enhanced search
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (productSearch) {
                productSearch.addEventListener('input', function(e) {
                    ...
                    handleProductSearch(query, 'umpan');
                });
            }
            ...
            if (sortSelect) {
                sortSelect.addEventListener('change', function(e) {
                    loadProducts('umpan', e.target.value);
                });
            }
        ...
        function createProductCard(product) {
            // Remove target_fish from umpan products - only show relevant specs
            const specs = [];
            if (product.lure_type) specs.push(`<div class="spec-item"><span class="spec-label">Jenis:</span> <span class="spec-value">${product.lure_type}</span></div>`);
            if (product.hook_size) specs.push(`<div class="spec-item"><span class="spec-label">Ukuran Kail:</span> <span class="spec-value">${product.hook_size}</span></div>`);
        ...
        function updateProductCount(count) {
            ...
            if (countElement) {
                countElement.textContent = `Menampilkan ${count} produk umpan & kail`;
            }
        }
